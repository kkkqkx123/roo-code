...
import { type ModeConfig, type PromptComponent, customModesSettingsSchema, modeConfigSchema } from "@shared/types"
		...
		try {
			...
			if (rulesFolderExists) {
				try {
					...
					vscode.window.showWarningMessage(t("common:customModes.errors.rulesCleanupFailed", { rulesFolderPath }))
