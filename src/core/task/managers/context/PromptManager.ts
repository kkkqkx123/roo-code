		...
		if (mcpEnabled) {
			...
			return SYSTEM_PROMPT(
				...
				state?.maxReadFileLine !== -1,
				{
					...
					useAgentRules: vscode.workspace.getConfiguration("coder").get<boolean>("useAgentRules") ?? true,
					newTaskRequireTodos: vscode.workspace.getConfiguration("coder").get<boolean>("newTaskRequireTodos") ?? false,
				},
				todoList ?? [],
