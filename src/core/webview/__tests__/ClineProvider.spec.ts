// pnpm --filter coder test core/webview/__tests__/ClineProvider.spec.ts
...
describe("ClineProvider", () => {
	...
	test("postMessageToWebview sends message to webview", async () => {
		...
		const mockState: ExtensionState = {
			...
			terminalOutputCharacterLimit: undefined,
			...
			includeDiagnosticMessages: undefined,
			maxDiagnosticMessages: undefined,
			includeTaskHistoryInEnhance: undefined,
			reasoningBlockCollapsed: undefined,
			enterBehavior: undefined,
			includeCurrentTime: undefined,
			includeCurrentCost: undefined,
