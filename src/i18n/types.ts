...
export interface TranslationParams {
  ...
  'common:errors.claudeCode.notAuthenticated': { defaultValue: string }
  ...
  'common:errors.message.message_not_found': { messageTs: number }
  ...
  'common:errors.missing_param': { toolName: string; paramName: string; relPath?: string }
  ...
  'tools:generateImage.failedWithStatus': { status: number; statusText?: string }
  ...
  // Common namespace - input
  'common:input.task_prompt': Record<string, never>
  'common:input.task_placeholder': Record<string, never>

  // Common namespace - customModes
  'common:customModes.errors.yamlParseError': { line: string | number }
  ...
  // Common namespace - welcome
  'common:welcome': { name: string; count: number }

  // Common namespace - items
  ...
  'tools:readFile.imageTooLarge': { size: number | string; max: number }
  ...
  'embeddings:textExceedsTokenLimit': { index?: number; itemTokens?: number; maxTokens: number; text?: string; prefix?: string; estimatedTokens?: number }
  'embeddings:textWithPrefixExceedsTokenLimit': { index?: number; itemTokens?: number; maxTokens: number; text?: string; prefix?: string; estimatedTokens?: number }
  ...
  'mcp:errors.disconnect_servers_partial': { count: number; errors: string }
